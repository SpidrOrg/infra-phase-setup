...
class PipelineStack extends Stack {
  constructor(scope, id, props) {
    ...
    const {platformTfRepo, codestarConnArn} = props;
    // Create IAM Role
    const pipelineRole = new iam.Role(this, 'platformCodepipelineRole', {
      roleName: "cdk-platform-codepipeline-role",
    ...
    const codebuildProjectRole = new iam.Role(this, 'platformCodebuildrole', {
      roleName: "cdk-platform-codebuild-role",
